...
OUTPUT_DIR="knowledge-incorporation/results/query_server_trained6"
mkdir -p "${OUTPUT_DIR}"

# -------- Experiment Grid -------------------------------------------- #
# Columns: exp_name dataset  k  evalT  r  α  drop  ep  lr  bs  ga  n_articles
EXPERIMENTS=(
	"eval_baseline knowledge-incorporation/data/synthetic_data/eval/iter2_val.json  1  1  32  64  0  10  1e-3  1  1 200"
)
